PROGRAM MICROWRAPPER
  ...
  !OUTPUT VARIABLES
  REAL, DIMENSION(NTIMES+1) :: QVOUT,QCOUT,QROUT,QSOUT,QIOUT,QNCOUT,QNROUT,QNSOUT,QNIOUT,TIMESOUT,RHOICEOUT,PHIOUT,RELHOUT
  REAL, DIMENSION(NTIMES+1) :: THOUT,POUT,AICEOUT,CICEOUT,ICEDEPOUT,ICESUBOUT,RAINEVAPOUT,SNOWEVAPOUT,SNOWMELTOUT
