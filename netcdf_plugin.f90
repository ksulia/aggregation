...
SUBROUTINE DEFINEDIMS(ncid,tid,nt,dname)
  ...
  STATUS = NF90_DEF_DIM(NCID,dname,nt,tid)
...
SUBROUTINE WRITEVAR5D(NCID,DAT,N1,N2,N3,N4,TIME2,NAME)
  ...
  CHARACTER*(*) :: NAME
  REAL, DIMENSION(N1,N2,N3,N4,TIME2) :: DAT
  
  
  STATUS = NF90_INQ_VARID(NCID,NAME,VAR)
  !write(*,*) "here",var
  
  STATUS = NF90_PUT_VAR(NCID,VAR,DAT,START = (/1,1,1,1,1/), COUNT = (/N1,N2,N3,N4,TIME2/))
