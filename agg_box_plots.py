...
#plt.xlabel('Time (s)', **axis_font)
plt.title('q$_{vapor}$ g kg$^{-1}$', **title_font)
ax1.ticklabel_format(style='sci', scilimits=(-3,3), axis='y')
...
#plt.xlabel('Time (s)', **axis_font)
plt.title('q$_{ice}$ g kg$^{-1}$', **title_font)
ax1.ticklabel_format(style='sci', scilimits=(-3,3), axis='y')
...
#plt.xlabel('Time (s)', **axis_font)
plt.title('q$_{cloud}$ g kg$^{-1}$', **title_font)
ax1.ticklabel_format(style='sci', scilimits=(-3,3), axis='y')
...
#plt.xlabel('Time (s)', **axis_font)
plt.title('q$_{snow}$ g kg$^{-1}$', **title_font)
ax1.ticklabel_format(style='sci', scilimits=(-3,3), axis='y')
...
#plt.xlabel('Time (s)', **axis_font)
plt.title('q$_{rain}$ g kg$^{-1}$', **title_font)
ax1.ticklabel_format(style='sci', scilimits=(-3,3), axis='y')
if any(qr) > 0: ax1.set_yscale('log')

ax1 = plt.subplot(gs[8])
P1 = ax1.plot(time,qg*1000.)
#plt.xlabel('Time (s)', **axis_font)
plt.title('q$_{graup}$ g kg$^{-1}$', **title_font)
ax1.ticklabel_format(style='sci', scilimits=(-3,3), axis='y')
if any(qg) > 0: ax1.set_yscale('log')

ax1 = plt.subplot(gs[9])
P1 = ax1.plot(time,ai*1.e6)
P2 = ax1.plot(time,ci*1.e6)
plt.xlabel('Time (s)', **axis_font)
plt.title(r'axis length $\mu$m', **title_font)
plt.legend(['a','c'])
...
plt.xlabel('Time (s)', **axis_font)
plt.title('Ice Source', **title_font)
...
plt.xlabel('Time (s)', **axis_font)
plt.title(r'$\rho_{ice}$  kg m$^{-3}$', **title_font)
